...
$config['biasset_register_scripts'] = array(
    ...
    'jqueryui-core' => array(
        'src' => $bower_path.'jqueryui/ui/minified/core.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jquery'),
        ),
    'jqueryui-mouse' => array(
        'src' => $bower_path.'jqueryui/ui/minified/mouse.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-widget' => array(
        'src' => $bower_path.'jqueryui/ui/minified/widget.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-button' => array(
        'src' => $bower_path.'jqueryui/ui/minified/button.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-menu' => array(
        'src' => $bower_path.'jqueryui/ui/minified/menu.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-position' => array(
        'src' => $bower_path.'jqueryui/ui/minified/position.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-mouse'),
        ),
    'jqueryui-draggable' => array(
        'src' => $bower_path.'jqueryui/ui/minified/draggable.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-mouse'),
        ),
    'jqueryui-droppable' => array(
        'src' => $bower_path.'jqueryui/ui/minified/droppable.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-resizable' => array(
        'src' => $bower_path.'jqueryui/ui/minified/resizable.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-selectable' => array(
        'src' => $bower_path.'jqueryui/ui/minified/selectable.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-accordion' => array(
        'src' => $bower_path.'jqueryui/ui/minified/accordion.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-effect'),
        ),
    'jqueryui-autocomplete' => array(
        'src' => $bower_path.'jqueryui/ui/minified/autocomplete.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-menu', 'jqueryui-position'),
        ),
    'jqueryui-datepicker' => array(
        'src' => $bower_path.'jqueryui/ui/minified/datepicker.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-datepicker-id' => array(
        'src' => $bower_path.'jqueryui/ui/minified/i18n/datepicker-id.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-datepicker'),
        ),
    'jqueryui-dialog' => array(
        'src' => $bower_path.'jqueryui/ui/minified/dialog.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-button', 'jqueryui-position', 'jqueryui-draggable', 'jqueryui-resizable'),
        ),
    'jqueryui-progressbar' => array(
        'src' => $bower_path.'jqueryui/ui/minified/progressbar.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-slider' => array(
        'src' => $bower_path.'jqueryui/ui/minified/slider.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jq-mousewheel'),
        ),
    'jqueryui-sortable' => array(
        'src' => $bower_path.'jqueryui/ui/minified/sortable.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget'),
        ),
    'jqueryui-spinner' => array(
        'src' => $bower_path.'jqueryui/ui/minified/spinner.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-button', 'jq-mousewheel'),
        ),
    'jqueryui-tabs' => array(
        'src' => $bower_path.'jqueryui/ui/minified/tabs.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-effect'),
        ),
    'jqueryui-tooltip' => array(
        'src' => $bower_path.'jqueryui/ui/minified/tooltip.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-widget', 'jqueryui-position', 'jqueryui-effect'),
        ),
    'jqueryui-effect' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-blind' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-blind.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-bounce' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-bounce.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-clip' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-clip.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-drop' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-drop.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-explode' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-explode.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-fade' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-fade.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-fold' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-fold.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-highlight' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-highlight.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-pulsate' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-pulsate.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-scale' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-scale.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-shake' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-shake.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-slide' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-slide.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
    'jqueryui-effect-transfer' => array(
        'src' => $bower_path.'jqueryui/ui/minified/effect-transfer.min.js',
        'ver' => $jqueryui_version,
        'dep' => array('jqueryui-core'),
        ),
