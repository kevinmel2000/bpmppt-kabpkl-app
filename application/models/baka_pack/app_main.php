...
class App_main extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->username = $this->authen->get_username();
    ...
    public function navbar()
    {
        ...
        $this->themee->add_navmenu( 'user_navbar', 'account', 'link', 'profile', $this->username );
    ...
    public function account_navbar( $parent_id, $position )
    {
        ...
        $this->themee->add_navmenu( $parent_id, 'profilse', 'link', 'profile', $this->username, array(), $position );
