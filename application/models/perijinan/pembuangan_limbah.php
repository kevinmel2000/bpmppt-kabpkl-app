	...
	public function form( $data_id = '' )
	{
		$fields = array(
			...
			array(
				...
				'type'	=> 'text',
				'std'	=> ($data_id != '' ? $query->limbah_kapasitas_produksi : set_value($this->slug.'_limbah_kapasitas_produksi')),
				'validation'=> 'required' ),
			array(
				...
				'fields'=> array(
					array(
						...
						'label'	=> 'proses',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_debit_max_proses : set_value($this->slug.'_limbah_debit_max_proses')),
						'validation'=> 'required' ),
					array(
						'col'	=> '6',
						'name'	=> 'kond',
						'label'	=> 'kondensor',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_debit_max_kond : set_value($this->slug.'_limbah_debit_max_kond')),
						'validation'=> 'required' ),
					)
				),
			array(
				...
				'fields'=> array(
					array(
						...
						'label'	=> 'BOD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_proses_kond : set_value($this->slug.'_limbah_kadar_max_proses_kond')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'cod',
						'label'	=> 'COD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_proses_cod : set_value($this->slug.'_limbah_kadar_max_proses_cod')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'tts',
						'label'	=> 'TTS',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_proses_tts : set_value($this->slug.'_limbah_kadar_max_proses_tts')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'minyak',
						'label'	=> 'Minyak',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_proses_minyak : set_value($this->slug.'_limbah_kadar_max_proses_minyak')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'sulfida',
						'label'	=> 'Silfida',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_proses_sulfida : set_value($this->slug.'_limbah_kadar_max_proses_sulfida')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'ph',
						'label'	=> 'pH',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_proses_ph : set_value($this->slug.'_limbah_kadar_max_proses_ph')),
						'validation'=> 'required' ),
					)
				),
			array(
				...
				'fields'=> array(
					array(
						...
						'label'	=> 'BOD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_proses_kond : set_value($this->slug.'_limbah_beban_max_proses_kond')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'cod',
						'label'	=> 'COD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_proses_cod : set_value($this->slug.'_limbah_beban_max_proses_cod')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'tts',
						'label'	=> 'TTS',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_proses_tts : set_value($this->slug.'_limbah_beban_max_proses_tts')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'minyak',
						'label'	=> 'Minyak',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_proses_minyak : set_value($this->slug.'_limbah_beban_max_proses_minyak')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'sulfida',
						'label'	=> 'Silfida',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_proses_sulfida : set_value($this->slug.'_limbah_beban_max_proses_sulfida')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'ph',
						'label'	=> 'pH',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_proses_ph : set_value($this->slug.'_limbah_beban_max_proses_ph')),
						'validation'=> 'required' ),
					)
				),
			array(
				...
				'fields'=> array(
					array(
						...
						'label'	=> 'BOD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_kond_kond : set_value($this->slug.'_limbah_kadar_max_kond_kond')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'cod',
						'label'	=> 'COD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_kond_cod : set_value($this->slug.'_limbah_kadar_max_kond_cod')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'tts',
						'label'	=> 'TTS',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_kond_tts : set_value($this->slug.'_limbah_kadar_max_kond_tts')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'minyak',
						'label'	=> 'Minyak',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_kond_minyak : set_value($this->slug.'_limbah_kadar_max_kond_minyak')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'sulfida',
						'label'	=> 'Silfida',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_kond_sulfida : set_value($this->slug.'_limbah_kadar_max_kond_sulfida')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'ph',
						'label'	=> 'pH',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_kadar_max_kond_ph : set_value($this->slug.'_limbah_kadar_max_kond_ph')),
						'validation'=> 'required' ),
					)
				),
			array(
				...
				'fields'=> array(
					array(
						...
						'label'	=> 'BOD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_kond_kond : set_value($this->slug.'_limbah_beban_max_kond_kond')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'cod',
						'label'	=> 'COD',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_kond_cod : set_value($this->slug.'_limbah_beban_max_kond_cod')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'tts',
						'label'	=> 'TTS',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_kond_tts : set_value($this->slug.'_limbah_beban_max_kond_tts')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'minyak',
						'label'	=> 'Minyak',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_kond_minyak : set_value($this->slug.'_limbah_beban_max_kond_minyak')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'sulfida',
						'label'	=> 'Silfida',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_kond_sulfida : set_value($this->slug.'_limbah_beban_max_kond_sulfida')),
						'validation'=> 'required' ),
					array(
						'col'	=> '2',
						'name'	=> 'ph',
						'label'	=> 'pH',
						'type'	=> 'text',
						'std'	=> ($data_id != '' ? $query->limbah_beban_max_kond_ph : set_value($this->slug.'_limbah_beban_max_kond_ph')),
						'validation'=> 'required' ),
					)
				),
			array(
				...
				'type'	=> 'text',
				'std'	=> ($data_id != '' ? $query->target_buang : set_value($this->slug.'_target_buang')),
				'validation'=> 'required' ),
			);
