...
<tr style="border: 2px solid #000">
    <td colspan="4" style="width:65%"><span class="underline bold">AGENDA PENDAFTARAN</span><br>NOMOR: <?php echo $no_daftar ?></td>
    <td colspan="2" style="width:35%; border-right: 2px solid #000;">TANGGAL : <?php echo format_date($surat_tanggal) ?></td>
</tr>
<tr><td colspan="6" style="width:100%; line-height: 5px"></td></tr>
